...
Game_CharacterBase.prototype.canPassDiagonally = function(x, y, horz, vert) {
    ...
    if (this.canPass(x, y, horz) && this.canPass(x, y2, horz) &&
            this.canPass(x, y, vert) && this.canPass(x2, y, vert)) {
        return true;
    }
    return false;
};
...
Game_CharacterBase.prototype.isNearTheScreen = function() {
    ...
    return px >= -tw && px <= gw && py >= -th && py <= gh;
};
...
Game_CharacterBase.prototype.checkEventTriggerHere = function(triggers) {
};

Game_CharacterBase.prototype.checkEventTriggerThere = function(triggers) {
};

Game_CharacterBase.prototype.checkEventTriggerAuto = function() {
};
...
Game_CharacterBase.prototype.jump = function(xPlus, yPlus) {
    ...
    this._x += xPlus;
    this._y += yPlus;
    var distance = Math.sqrt(xPlus * xPlus + yPlus * yPlus);
