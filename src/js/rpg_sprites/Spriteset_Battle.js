...
Spriteset_Battle.prototype.locateBattleback = function() {
    ...
    sprite2.origin.x = sprite2.x + (sprite2.bitmap.width - width) / 2;
    if ($gameSystem.isSideView()) {
        sprite1.origin.y = sprite1.y + (sprite1.bitmap.height - height) / 2;
        sprite2.origin.y = sprite2.y + (sprite2.bitmap.height - height) / 2;
    }
};
...
Spriteset_Battle.prototype.isAnimationPlaying = function() {
    return this._enemySprites.some(function(sprite) {
        return sprite.isAnimationPlaying();
    }) || this._actorSprites.some(function(sprite) {
        return sprite.isAnimationPlaying();
    });
};
