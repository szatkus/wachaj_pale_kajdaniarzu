...
/*
 * Gets the tileset specified in the normal case.
 * However, this method does not get the tileset from the cache in the
 * event test mode.
 */
...
Spriteset_Map.prototype.updateWeather = function() {
    ...
    this._weather.origin.x = $gameMap.displayX() * this.tileWidth;
    this._weather.origin.y = $gameMap.displayY() * this.tileHeight;
};
