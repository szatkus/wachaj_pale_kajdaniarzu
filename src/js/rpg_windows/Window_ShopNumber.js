...
Window_ShopNumber.prototype.itemY = function() {
    return Math.floor(this.contentsHeight() / 2 - this.lineHeight() * 1.5);
};

Window_ShopNumber.prototype.priceY = function() {
    return Math.floor(this.contentsHeight() / 2 + this.lineHeight() / 2);
};

Window_ShopNumber.prototype.buttonY = function() {
    return Math.floor(this.priceY() + this.lineHeight() * 2.5);
};
